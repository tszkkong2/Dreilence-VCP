...
window.WhiteboardUi = {
	...
	addListeners: function() {
		...
		WhiteboardUi.getElement('clear_all').mousedown(Whiteboard.clearAll);
	...
	activatePencil: function(event) {
		...
		WhiteboardUi.canvasElement.bind("touchstart", WhiteboardUi.beginPencilDraw);
	...
	beginPencilDraw: function(event) {
		x = WhiteboardUi.getX(event)
		y = WhiteboardUi.getY(event)
		if (isNaN(x) && isNaN(y)){
			e = event.originalEvent;
			x = e.changedTouches[0].pageX;
			y = e.changedTouches[0].pageY-44;
		    Whiteboard.beginPencilDraw(x, y);
	    ...
	    WhiteboardUi.canvasElement.bind("mousemove", function(event) {
	        ...
	        //console.log(WhiteboardUi.getX(event)+","+ WhiteboardUi.getY(event));
	    });
		...
		WhiteboardUi.canvasElement.bind("touchmove", function(event) {
			e = event.originalEvent;
			x = e.changedTouches[0].pageX;
			y = e.changedTouches[0].pageY-44;
	        Whiteboard.pencilDraw(x, y);
	    });
	    WhiteboardUi.canvasElement.bind("touchend", WhiteboardUi.endPencilDraw);
	   	WhiteboardUi.canvasElement.bind("touchleave", WhiteboardUi.endPencilDraw);
	   	WhiteboardUi.canvasElement.bind("touchcancel", WhiteboardUi.endPencilDraw);
	...
	endPencilDraw: function (event) {
		...
		WhiteboardUi.canvasElement.unbind("touchmove");
		WhiteboardUi.canvasElement.unbind("touchend");
		WhiteboardUi.canvasElement.unbind("touchleave");
		WhiteboardUi.canvasElement.unbind("touchcancel");
		canDraw=true;
 ...
 */
/**
 * JQuery functioita voi lis?t? n?in. T?t? funktiota voisi nyt
